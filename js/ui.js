...
function applyTheme(id){
  ...
  const themeCanvasColors={
    dark:  {orb1:[251,146,6,.11],  orb2:[234,88,12,.07],  line:[251,146,6,.07],  bg1:[28,16,0],  bg2:[12,8,0]},
    light: {orb1:[180,100,0,.08],  orb2:[220,140,0,.05],  line:[180,100,0,.06],  bg1:[240,220,170],bg2:[253,246,227]},
    amoled:{orb1:[251,146,6,.09],  orb2:[234,88,12,.05],  line:[251,146,6,.05],  bg1:[15,8,0],   bg2:[0,0,0]},
    forest:{orb1:[0,220,120,.1],   orb2:[0,180,80,.06],   line:[0,220,120,.06],  bg1:[4,18,8],   bg2:[2,12,6]},
    ocean: {orb1:[0,190,255,.1],   orb2:[0,140,220,.06],  line:[0,190,255,.06],  bg1:[4,16,28],  bg2:[1,8,16]},
    purple:{orb1:[160,100,255,.1], orb2:[120,60,220,.06], line:[160,100,255,.06],bg1:[14,4,24],  bg2:[7,1,15]},
    ruby:  {orb1:[255,40,80,.1],   orb2:[200,20,50,.06],  line:[255,40,80,.06],  bg1:[20,2,4],   bg2:[15,0,2]},
    matrix:{orb1:[0,255,65,.12],   orb2:[0,200,50,.07],   line:[0,255,65,.08],   bg1:[0,14,4],   bg2:[1,8,2]},
    sunset:{orb1:[255,120,0,.12],  orb2:[200,60,0,.07],   line:[255,120,0,.07],  bg1:[24,10,0],  bg2:[15,5,0]},
    rose:  {orb1:[255,64,176,.12],  orb2:[200,20,120,.07], line:[255,64,176,.07], bg1:[18,0,12],  bg2:[13,0,8]},
    ice:   {orb1:[96,208,255,.1],   orb2:[0,160,220,.06],  line:[96,208,255,.06], bg1:[0,14,22],  bg2:[0,8,15]},
    lava:  {orb1:[255,68,0,.13],    orb2:[200,20,0,.08],   line:[255,68,0,.08],   bg1:[18,2,0],   bg2:[10,0,0]},
    mint:  {orb1:[0,168,100,.08],   orb2:[0,200,120,.05],  line:[0,168,100,.06],  bg1:[212,240,229],bg2:[240,250,246]},
    sand:  {orb1:[212,160,32,.1],   orb2:[180,120,0,.06],  line:[212,160,32,.06], bg1:[22,16,0],  bg2:[16,12,0]},
    neon:  {orb1:[255,0,255,.12],   orb2:[0,255,255,.07],  line:[255,0,255,.07],  bg1:[10,0,10],  bg2:[2,0,2]},
    earth: {orb1:[160,120,64,.1],   orb2:[100,80,20,.06],  line:[160,120,64,.06], bg1:[16,10,0],  bg2:[8,5,0]},
    cherry:{orb1:[200,40,80,.08],   orb2:[160,20,60,.05],  line:[200,40,80,.06],  bg1:[232,208,216],bg2:[248,240,242]},
    slate: {orb1:[96,144,224,.1],   orb2:[60,100,180,.06], line:[96,144,224,.06], bg1:[18,22,32],  bg2:[10,12,16]},
  };
  window._canvasTheme = themeCanvasColors[id] || themeCanvasColors.dark;
}
...
function updateAllUI(){
  ...
  const hi=document.getElementById('heroChar'); if(hi){ hi.innerHTML='<img src="'+ch.img+'" style="width:90px;height:90px;object-fit:contain">'; }
