...
function applyTheme(id){
  ...
  const themeCanvasColors={
    dark:   {bg1:[18,10,2],    bg2:[8,4,16],   orb1:[255,150,0,.22],  orb2:[255,60,0,.14],   orb3:[120,40,255,.08]},
    light:  {bg1:[248,244,255],bg2:[255,252,240],orb1:[160,80,255,.1], orb2:[255,180,0,.07],  orb3:[0,180,255,.05]},
    amoled: {bg1:[0,0,0],      bg2:[0,0,0],    orb1:[255,255,255,.06],orb2:[255,255,255,.03], orb3:[0,200,255,.04]},
    forest: {bg1:[6,20,8],     bg2:[2,10,4],   orb1:[0,220,80,.22],   orb2:[80,200,0,.14],   orb3:[0,160,60,.08]},
    ocean:  {bg1:[0,10,28],    bg2:[0,4,16],   orb1:[0,180,255,.2],   orb2:[0,80,200,.14],   orb3:[0,255,220,.08]},
    purple: {bg1:[12,2,28],    bg2:[4,0,16],   orb1:[180,60,255,.22], orb2:[100,30,255,.14], orb3:[255,60,200,.08]},
    ruby:   {bg1:[160,0,20],   bg2:[100,0,10], orb1:[255,80,80,.25],  orb2:[255,30,30,.15],  orb3:[255,180,180,.1]},
    matrix: {bg1:[0,12,2],     bg2:[0,4,0],    orb1:[0,255,60,.2],    orb2:[0,180,40,.12],   orb3:[120,255,0,.07]},
    sunset: {bg1:[50,12,28],   bg2:[30,4,18],  orb1:[255,120,0,.24],  orb2:[255,20,100,.16], orb3:[255,220,0,.1]},
    rose:   {bg1:[220,0,140],  bg2:[180,0,100],orb1:[255,255,0,.25],  orb2:[255,255,255,.12],orb3:[0,255,220,.1]},
    ice:    {bg1:[220,242,252],bg2:[240,252,255],orb1:[0,160,220,.15],orb2:[100,200,240,.1], orb3:[180,230,255,.08]},
    lava:   {bg1:[70,14,0],    bg2:[40,6,0],   orb1:[255,100,0,.28],  orb2:[255,40,0,.18],   orb3:[255,200,0,.12]},
    mint:   {bg1:[230,252,242],bg2:[245,255,250],orb1:[0,180,110,.12],orb2:[0,210,150,.08],  orb3:[80,220,180,.06]},
    sand:   {bg1:[240,220,160],bg2:[255,240,200],orb1:[200,130,0,.18],orb2:[180,80,0,.12],   orb3:[240,200,80,.1]},
    neon:   {bg1:[12,0,20],    bg2:[6,0,12],   orb1:[255,10,200,.26], orb2:[255,230,0,.18],  orb3:[0,240,255,.14]},
    volcano:{bg1:[40,6,0],     bg2:[20,2,0],   orb1:[255,80,0,.26],   orb2:[255,30,0,.18],   orb3:[255,180,0,.12]},
    cherry: {bg1:[250,232,240],bg2:[255,245,248],orb1:[200,10,50,.1], orb2:[160,0,40,.07],   orb3:[255,100,140,.06]},
    aurora: {bg1:[2,14,28],    bg2:[0,6,16],   orb1:[0,255,160,.22],  orb2:[0,180,255,.14],  orb3:[160,0,255,.1]},
  };
  const t = themeCanvasColors[id] || themeCanvasColors.dark;
  window._canvasOrb3 = t.orb3 || null;
...
function renderThemeGrid(){
  ...
  var meta={
    dark:   {bg:'#120a02',c1:'#f59200',c2:'#fbbf24'},
    light:  {bg:'#f8f4ff',c1:'#7030d0',c2:'#9020f0'},
    amoled: {bg:'#000000',c1:'#ffffff',c2:'#aaaaaa'},
    forest: {bg:'#0a1f0d',c1:'#3ddc6c',c2:'#6aff96'},
    ocean:  {bg:'#010d20',c1:'#00ccff',c2:'#40e0ff'},
    purple: {bg:'#06021a',c1:'#b04aff',c2:'#d080ff'},
    ruby:   {bg:'#8b0010',c1:'#ffffff',c2:'#ffaaaa'},
    matrix: {bg:'#000a02',c1:'#00ff41',c2:'#00dd35'},
    sunset: {bg:'#2d0a1e',c1:'#ff8c00',c2:'#ffb347'},
    rose:   {bg:'#e0008e',c1:'#ffee00',c2:'#ffffff'},
    ice:    {bg:'#ddf0fa',c1:'#0090cc',c2:'#00aaee'},
    lava:   {bg:'#3a0800',c1:'#ff6600',c2:'#ffaa00'},
    mint:   {bg:'#e8faf2',c1:'#009960',c2:'#00bb70'},
    sand:   {bg:'#f0deb0',c1:'#b07000',c2:'#cc8800'},
    neon:   {bg:'#0a0010',c1:'#ff10cc',c2:'#ffee00'},
    volcano:{bg:'#1a0400',c1:'#ff5500',c2:'#ff8800'},
    cherry: {bg:'#f5e8ec',c1:'#cc1045',c2:'#e03565'},
    aurora: {bg:'#020c18',c1:'#00ffaa',c2:'#00ddcc'},
  };
