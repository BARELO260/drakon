...
window.LESSON_BANKS.EN = [
  ...
  },
  {
    ...
    ex:[
      ["mcq","¿Cómo preguntas dónde está la puerta de embarque?",["Where is gate B7, please?","Where is the boarding door B7?","Where stand the gate B7 is?","Which is gate B7 where?"],0,"\"Where is gate B7, please?\" es directa, natural y cortés. En los aeropuertos se dice \"gate\" (puerta de embarque), no \"door\". También es válido \"How do I find gate B7?\".","✈️ Estás en el aeropuerto con tu boarding pass."],
      ["fill","\"I'd like to ___ a room for two nights, please.\"",["book","do","give","open"],0,"\"Book a room\" (o \"reserve a room\") es la forma habitual de pedir una habitación. \"Make\" solo funciona con \"a reservation\": \"make a reservation\"."],
      ...
      ["mcq","El hotel dice que tu habitación no está lista (check-in a las 3pm y son las 12pm). ¿Qué preguntas?",["Can I leave my luggage here while I wait?","Give me a room right now.","Why is your hotel so slow?","I won't wait, find me a room."],0,"Preguntar si puedes dejar el equipaje es cortés y práctico. Preguntar si puedes esperar en el lobby o dónde comer cerca también sería válido, pero las otras opciones son exigentes o descorteses."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [that / seem / fair / doesn't]",["That doesn't seem fair.","It doesn't seem that fair.","That seem doesn't fair.","Doesn't that seem fair."],0,"\"That doesn't seem fair.\" = Eso no parece justo. \"Doesn't seem\" es más suave que \"isn't\" — sirve para expresar opinión sin ser muy absoluto. \"It doesn't seem fair\" también es correcta (opción B)."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["translate","Traduce: \"A menos que llueva, iremos a la playa.\"",["Unless it rains, we'll go to the beach.","Unless it doesn't rain, we'll go to the beach.","Except it rains, we will go to the beach.","Unless it will rain, we'll go to the beach."],0,"\"Unless it rains\" (a menos que llueva) equivale a \"if it doesn't rain\" (si no llueve). Ojo: \"unless\" ya es negativo, así que no se combina con \"doesn't\"; y tras \"unless\" se usa presente, no \"will\"."],
      ...
      ["arrange","Ordena: [had / he / earlier / arrived / if / caught / he / would / have / the / train]",["If he had arrived earlier, he would have caught the train.","arrived he caught earlier, If the have would train. he had","he earlier, have would If he train. arrived had the caught","would he train. caught the he If arrived earlier, had have"],0,"Condicional 3: If + past perfect (had arrived), would have + participio (would have caught). La cláusula \"if\" también puede ir al final, sin coma; aquí la ordenamos al principio."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [before / sign / read / the / lease / you / you]",["you read the lease before you sign","lease before you the you read sign","sign you the before lease read you","you read you lease the sign before"],0,"Sujeto + verbo + artículo + sustantivo + conector temporal + sujeto + verbo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [habit / build / takes / a / time / new / to]",["a new habit takes time to build","time takes habit new a to build","to build a new takes habit time","build new takes time a to habit"],0,"Artículo + adjetivo + sustantivo + verbo + sustantivo + infinitivo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [have / civilization / this / ancient / built / an / must]",["civilization ancient an must this built have","an ancient civilization must have built this","built civilization have this ancient must an","built must this civilization an ancient have"],1,"Artículo + adjetivo + sustantivo + modal + participio + pronombre."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [trail / this / hiking / long / is]",["trail this long hiking is","this hiking trail is long","hiking long is trail this","this long hiking is trail"],1,"Pronombre + sustantivo + verbo + adjetivo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [hive / bees / that / live / the / in / the]",["the bees that live in the hive","bees the the hive live in that","hive the in live the bees that","the in the live bees that hive"],0,"Artículo + sustantivo + “that” + verbo + preposición + artículo + sustantivo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [treaty / negotiate / nations / the / will / the]",["the nations will negotiate the treaty","negotiate the nations treaty the will","treaty will the nations negotiate the","negotiate will the the nations treaty"],0,"Artículo + sustantivo + auxiliar + verbo + artículo + sustantivo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [engine / has / mechanic / the / fixed / the]",["fixed has the engine mechanic the","the mechanic has fixed the engine","the the has fixed mechanic engine","mechanic fixed the engine the has"],1,"Artículo + sustantivo + auxiliar + participio + artículo + sustantivo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [tightrope / on / walks / the / clown / the]",["on walks the the tightrope clown","the clown walks on the tightrope","on the walks tightrope clown the","the the tightrope clown on walks"],1,"Artículo + sustantivo + verbo + preposición + artículo + sustantivo."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["mcq","Elige la mejor traducción al español: “Whatever the scribe intended, the meaning is now lost.”",["Sea lo que sea que el escriba haya querido decir, el significado ahora se ha perdido.","Lo que el escriba quiso decir, el significado ahora se ha perdido.","Sea lo que sea que el escriba haya querido decir, el significado ahora se pierde.","Sea lo que el escriba haya querido decir, el significado ahora se ha perdido."],0,"“Whatever” se traduce con “sea lo que sea que”, subjuntivo en español."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["mcq","Elige la mejor traducción al español: “Little did anyone expect such a severe logistics disruption.”",["Alguien esperaba una interrupción logística tan grave.","Nadie esperaba una interrupción logística tan grave.","Nadie esperó una interrupción logística tan severa.","Poco esperaba nadie una interrupción logística tan grave."],1,"“Little did anyone expect” se traduce naturalmente con “nadie esperaba” en español, sin inversión literal."],
  ...
  },
  {
    ...
    ex:[
      ...
      ["arrange","Ordena: [signal / weak / is / this]",["weak this is signal","this weak signal is","this signal is weak","this signal weak is"],2,"Pronombre + sustantivo + verbo + adjetivo."],
