...
const MONETIZATION = {
  ...
  limits: {
    free: {
      ...
      ttsCharsPerDay: 6000,     // caracteres de voz ElevenLabs por día (~6 min de audio) — al agotarse, la voz se desactiva hasta el reseteo diario o hasta pasar a Premium (sin reserva a la voz del navegador)
    },
    premium: {
...
/* ── Uso de TTS (caracteres hablados) ──────────────────────
   ...
   reseteo diario que el resto de contadores (ver state.js). Al agotarse,
   la voz se desactiva por completo hasta el reseteo o hasta pasar a
   Premium — ya NO hay reserva a la voz nativa del navegador (suena mal
   y por eso se decidió que, sin ElevenLabs disponible, es mejor no
   reproducir voz alguna). */
