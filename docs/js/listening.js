...
const ListeningProbe = (() => {
  ...
  function play() {
    ...
    // Motor de voz compartido (js/tts-eleven.js): solo ElevenLabs, sin
    // fallback a la voz nativa del dispositivo. Si no hay API key
    // configurada o la cuota se agotó, simplemente no suena nada.
